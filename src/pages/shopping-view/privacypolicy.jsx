  ...
  return (
    <>
      <main className="max-w-5xl mx-auto px-4 py-16 text-gray-800 font-josefin">
        ...
        <p className="mb-6">
          Welcome to Darzie’s Couture. We respect your privacy and are committed
          to protecting it through this Privacy Policy. This document explains
          how we collect, use, and safeguard your information when you visit our
          website at{" "}
          <a
            href="https://darziescouture.com"
            className="text-[#6C3D1D] underline"
          >
        ...
        <ul className="list-disc list-inside mb-6 space-y-2">
          <li>
            We at Darzie’s Couture are committed to respect and protect the
            information provided by you to us.
          </li>
          <li>
            Whether it is your address, mobile number, email ID or name, we make
            sure your information doesn’t leak to undesirable hands or unlawful
            entities.
          </li>
          <li>Your privacy is of utmost importance to us.</li>
          <li>
            On receiving your personal data, we accept your consent for
            collection, storage, use, disclosure and transfer of data by us for
            the purpose of transactions made by you for the purchase of product.
          </li>
          <li>
            This data collection does not violate any specific provision of law.
          </li>
        </ul>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Communicate regarding inquiries, updates, and promotional offers
            </li>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside mt-2">
            <li>
              <strong>Service Providers:</strong> To assist with payment
              processing, shipping, and other essential business functions.
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="mt-2">
            ...
            <li>
              <strong>Email:</strong>{" "}
              <a href="mailto:darziescouture@gmail.com" className="underline">
                darziescouture@gmail.com
              </a>
            </li>
            <li>
              <strong>Phone:</strong> 9872591994
            </li>
          </ul>
        </section>
      </main>
